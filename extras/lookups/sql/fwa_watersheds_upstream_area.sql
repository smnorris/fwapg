...
DROP TABLE IF EXISTS fwapg.fwa_watersheds_upstream_area_:wsg;

CREATE table fwapg.fwa_watersheds_upstream_area_:wsg
(watershed_feature_id integer, upstream_area double precision);

INSERT INTO fwapg.fwa_watersheds_upstream_area_:wsg
