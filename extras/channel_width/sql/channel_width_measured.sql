...
BEGIN;
  ...
  and e.localcode_ltree = '400.536025.503903.677855'::ltree
  ),
...
select distinct on (wscode_ltree, localcode_ltree)
  stream_sample_site_ids,
  stream_crossing_ids,
  wscode_ltree,
  localcode_ltree,
...
ORDER BY wscode_ltree, localcode_ltree, watershed_group_code; -- the same watershed / local code can occur across watershed groups, uniquify as wscodes are pk
