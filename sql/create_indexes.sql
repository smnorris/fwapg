ALTER TABLE whse_basemapping.fwa_assessment_watersheds_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_assessment_watersheds_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_coastlines_sp ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_coastlines_sp ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_glaciers_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_glaciers_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_islands_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_islands_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_lakes_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_lakes_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_manmade_waterbodies_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_manmade_waterbodies_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_wetlands_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_wetlands_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_rivers_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_rivers_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_obstructions_sp ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_obstructions_sp ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_linear_boundaries_sp ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_linear_boundaries_sp ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_stream_networks_sp ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_stream_networks_sp ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
-- CREATE INDEX ON whse_basemapping.fwa_stream_networks_sp (stream_order);
...
ALTER TABLE whse_basemapping.fwa_watersheds_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
ALTER TABLE whse_basemapping.fwa_watersheds_poly ALTER COLUMN localcode_ltree SET DATA TYPE ltree USING localcode_ltree::ltree;
...
ALTER TABLE whse_basemapping.fwa_named_watersheds_poly ALTER COLUMN wscode_ltree SET DATA TYPE ltree USING wscode_ltree::ltree;
