drop table if exists fwapg.fwa_manmade_waterbodies_poly;

create table fwapg.fwa_manmade_waterbodies_poly (
...
insert into fwapg.fwa_manmade_waterbodies_poly (
  waterbody_poly_id,
  watershed_group_id,
  waterbody_type,
  waterbody_key,
...
from fwapg.fwa_manmade_waterbodies_poly_load;

create index on fwapg.fwa_manmade_waterbodies_poly (blue_line_key);
create index on fwapg.fwa_manmade_waterbodies_poly (watershed_key);
create index on fwapg.fwa_manmade_waterbodies_poly (waterbody_key);
create index on fwapg.fwa_manmade_waterbodies_poly (watershed_group_code);
create index on fwapg.fwa_manmade_waterbodies_poly (gnis_name_1);
create index on fwapg.fwa_manmade_waterbodies_poly using gist (wscode_ltree);
create index on fwapg.fwa_manmade_waterbodies_poly using btree (wscode_ltree);
create index on fwapg.fwa_manmade_waterbodies_poly using gist (localcode_ltree);
create index on fwapg.fwa_manmade_waterbodies_poly using btree (localcode_ltree);
create index on fwapg.fwa_manmade_waterbodies_poly using gist (geom);