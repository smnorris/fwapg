delete from whse_basemapping.fwa_glaciers_poly where watershed_group_code = :'wsg';

insert into whse_basemapping.fwa_glaciers_poly (
  waterbody_poly_id,
  watershed_group_id,
  waterbody_type,
  waterbody_key,
...
select
  ...
  area_ha::double precision::double precision as area_ha,
