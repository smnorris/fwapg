drop table if exists fwapg.fwa_lakes_poly;

create table fwapg.fwa_lakes_poly (
...
insert into fwapg.fwa_lakes_poly (
  waterbody_poly_id,
  watershed_group_id,
  waterbody_type,
  waterbody_key,
...
from fwapg.fwa_lakes_poly_load;

create index on fwapg.fwa_lakes_poly (blue_line_key);
create index on fwapg.fwa_lakes_poly (watershed_key);
create index on fwapg.fwa_lakes_poly (waterbody_key);
create index on fwapg.fwa_lakes_poly (watershed_group_code);
create index on fwapg.fwa_lakes_poly (gnis_name_1);
create index on fwapg.fwa_lakes_poly using gist (wscode_ltree);
create index on fwapg.fwa_lakes_poly using btree (wscode_ltree);
create index on fwapg.fwa_lakes_poly using gist (localcode_ltree);
create index on fwapg.fwa_lakes_poly using btree (localcode_ltree);
create index on fwapg.fwa_lakes_poly using gist (geom);